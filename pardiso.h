...
enum PARDISOINIT_ERROR_CODES{SUCCESS = 0, NO_LICENSE = -10, EXPIRED_LICENSE = -11, BAD_USER_OR_HOST = -12};
void Report_Pardisoinit_Error(int Error_Code) {
  switch(Error_Code) {
    case SUCCESS:
      printf("PardisoInit Error code %d:\n"
    ...
    default:
      printf("PardisoInit Error code UNKNOWN:\n"
